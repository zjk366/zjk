...
export const db = new Dexie('CherryStudio', {
  ...
  conversation_logs: EntityTable<ConversationLog, 'id'>
  local_skills: EntityTable<LocalSkill, 'id'>
}
...
db.version(11).stores({
  ...
  quick_phrases: 'id',
  message_blocks: 'id, messageId, file.id',
  memories: 'id, topicId, isDeleted, createdAt'
})
...
db.version(12).stores({
  ...
  message_blocks: 'id, messageId, file.id',
  memories: 'id, topicId, isDeleted, createdAt',
  conversation_logs: 'id, topicId, createdAt'
})
...
db.version(13).stores({
  ...
  memories: 'id, topicId, isDeleted, createdAt',
  conversation_logs: 'id, topicId, createdAt',
  local_skills: 'id, name, isEnabled, createdAt'
})
